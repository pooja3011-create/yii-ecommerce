...
class ProductReviewsController extends Controller {
    ...
    public function actionIndex() {
        ...
        if (Yii::$app->user->id != '1' && (!isset($rolePermitions['product_reviews']) || !in_array('list', $rolePermitions['product_reviews']))) {
    ...
    public function actionDelete($id) {
        ...
        Yii::$app->db->createCommand()->update('product_reviews', ['status' => '0'], ['id' => $id])->execute();
